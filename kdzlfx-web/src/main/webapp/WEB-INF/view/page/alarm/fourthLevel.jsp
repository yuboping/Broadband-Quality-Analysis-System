    ...
    <div class="index_center">
        <div class="clearfix">
            <h4 class="content_title"> 离网预警 
                ...
                <span class="content_title_small f14">四级预警</span>
            </h4>
        ...
        <div class="clearfix">
            <div class="half50 fl">
                <div class="content_bg mr3 ">
                    ...
                    <div class="half50 mt10" id="userStructure" style="width: 100%; height: 250px;"></div>
                </div>
            </div>
            <div class="half50 fl">
                <div class="content_bg ml3 ">
                    ...
                    <div class="half50 mt10" id="unrenewedRate" style="width: 100%; height: 250px;"></div>
                </div>
            </div>
        </div>
        <div class="clearfix">
        ...
        <div class="clearfix">
            ...
            <div class="half50 fl">
                <div class="content_bg ml3 ">
                    ...
                    <div class="half50 mt10" id="rateTrend" style="width: 100%; height: 250px;"></div>
                </div>
            </div>
        </div>
    </div>
    <script type="text/JavaScript" src="${staticPath}/js/ces/fourthLevel.js"></script>
    <!--foot-->
