package com.ainsg.lwfx.ott.service
...
import com.ainsg.lwfx.ott.config.OTTConf
...
import com.ainsg.lwfx.terminal.service.UserInfoService
...
//    ottData.show()
    ...
    JdbcOracleHelper.insertWithRDD(featuresData, insertSql)
  }
