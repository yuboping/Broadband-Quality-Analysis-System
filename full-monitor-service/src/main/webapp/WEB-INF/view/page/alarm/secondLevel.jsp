    ...
    <div class="index_center">
        <div class="clearfix">
            <h4 class="content_title"> 离网预警 
                ...
                <span class="content_title_small f14">二级预警</span>
            </h4>
        ...
        <div class="content_bg">
            ...
            <div id="silenceTrend" style="width: 100%; height: 250px;"></div>
        </div>
    </div>
    <script type="text/JavaScript" src="${staticPath}/js/ces/secondLevel.js"></script>
    <!--foot-->
